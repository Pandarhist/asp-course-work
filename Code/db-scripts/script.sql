...
/*  Created On : 16-дек-2022 11:09:20 				*/
...
(
	...
	[o_customer] int NULL,
	[o_employee] int NOT NULL,	-- Сотрудник, принявший заказ
	[o_status] int NOT NULL,	-- Статус заказа
...
(
	...
	[p_description] nvarchar(300) NULL,	-- Описание
...
(
	[pt_id] int NOT NULL IDENTITY (0, 1),
...
ALTER TABLE [Orders] ADD CONSTRAINT [FK_Orders_Staff]
	FOREIGN KEY ([o_employee]) REFERENCES [Staff] ([s_personnel_number]) ON DELETE No Action ON UPDATE No Action
GO
